    ...
    <div className="min-h-screen flex">
      ...
      >
        ...
        <div className="relative max-w-md text-center">
          ...
          <h2 className="text-3xl font-bold tracking-tight mb-4">Welcome Back to Al-Noor Academy</h2>
          <p className="text-muted-foreground leading-relaxed">
            Continue your Quran and Arabic learning journey with your certified teachers.
          </p>
          <div className="mt-10 grid grid-cols-2 gap-4 text-left">
            {["500+ Students", "30+ Teachers", "20+ Countries", "95% Satisfaction"].map((stat) => (
              <div key={stat} className="rounded-xl bg-card border border-border p-4 shadow-soft">
                <p className="text-sm font-semibold text-gradient">{stat}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        >
          ...
          <div className="rounded-2xl border border-border bg-card p-6 lg:p-8 shadow-card">
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              ...
              <Button type="submit" className="w-full gap-2 h-11 rounded-xl">
            ...
            <Button variant="outline" className="w-full gap-3 h-11 rounded-xl">
